...
const Link = forwardRef<HTMLAnchorElement, LinkProps>(function Link(props, ref) {
    ...
    const nextProps = { to: href, linkAs, replace, scroll, shallow, prefetch, locale };

    if (noLinkStyle) {
        return <NextLinkComposed className={className} ref={ref} {...nextProps} {...other} />;
    }

    return <MuiLink component={NextLinkComposed} className={className} ref={ref} {...nextProps} {...other} />;
});
